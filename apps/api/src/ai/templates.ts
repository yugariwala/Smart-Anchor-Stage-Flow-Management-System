...
const PHRASES: Record<Language, Phrases> = {
  ...
  gu: {
    welcome: (e) => `સે કોીનું સ્વાદેવું છે, ${e} માં।`.replace('।', '।'),
    introducing: (s) => `કૃપા કરીને ${s} નું સ્વાદેવું કરો।`,
    transition: 'આભાર। હવે અમે કાર્યક્રમના આગલા ભાગ તરફ જઈએ છીએ।',
    closing: (e) => `અહીં ${e} પૂર્ણ થાય છે। સે કોીનો આભાર।`,
    announcement: 'હાજર સે કોી માટે એક જાણ છે।',
    reviewNeeded: 'ટેમ્પલેટ ડ્રાફ્ટ: વપરાશ પહેલાં સમીક્ષા કરો।',
    noSpeaker: 'કૃપા કરીને આગલા વક્તાનું સ્વાદેવું કરો।',
  },
};
